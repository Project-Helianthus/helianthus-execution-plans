...
| MSP-DOCS-API-SCHEMA | helianthus-docs-eebus | RECOVERY_RECONCILIATION | 7 | GPT-5.5 high | DOCS-VERIFY | api-doc/schema | Not ready until DOCS-VERIFY completes; then merge `helianthus.eebus.api-surface.v1`, normalization rules, and golden positive/negative fixtures before extractor consumption. |
| MSP-DOCS-PLATFORM | helianthus-docs-ebus | RECOVERY_RECONCILIATION | 7 | GPT-5.5 high | MSP-R00-L, MSP-DOCS-API-SCHEMA | platform-doc | MSP-R00-L predecessor is satisfied after PR #62 merges; still not ready until MSP-DOCS-API-SCHEMA completes. Add platform contracts and `docs/platform/manifests/eebus-doc-ownership.yaml`. |
