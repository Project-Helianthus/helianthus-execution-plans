...
| MSP-DOCS-CANDIDATE-CLEANUP | helianthus-docs-eebus | RECOVERY_RECONCILIATION | 5 | GPT-5.5 medium | MSP-DOCS-E2 | conditional-cleanup | Dormant. Activates only when candidate expires or source PR closes unmerged; withdraws candidate artifacts and restores docs main green. |
