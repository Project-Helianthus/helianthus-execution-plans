...
| `ISSUE-GW-14` | `helianthus-ebusgateway` | Portal rollout work for observe-first evidence surfaces | active | next `M6` critical path after merged `ISSUE-GW-13`; target repo issue/PR not yet linked here |
