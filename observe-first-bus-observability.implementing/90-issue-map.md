...
| `ISSUE-GW-18I` | `helianthus-ebusgateway` | Fix passive proxy-session contract on proxy-single ENS | active | issue `Project-Helianthus/helianthus-ebusgateway#366`, active branch `issue/366-p03-passive-proxy-session-contract`; latest head `2b5df32`, `#365` remains open and parent PR `#354` remains open/draft |
