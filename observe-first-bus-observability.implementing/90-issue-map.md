...
| `ISSUE-GW-18I` | `helianthus-ebusgateway` | Fix passive proxy-session contract on proxy-single ENS | active | issue `Project-Helianthus/helianthus-ebusgateway#366`, stacked PR `#367` from `issue/366-p03-passive-proxy-session-contract`; latest head `350d4a33ee2c80af706d8a392ad2ddeed2d4eabd`, rerun artifact `results-matrix-ha/20260311T194649Z-issue366-p03-rerun` failed, and `#367` remains the active blocked lane not ready to fold upward into parent PR `#354` |
