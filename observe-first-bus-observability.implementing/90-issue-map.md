...
| `ISSUE-GW-18M` | `helianthus-ebusgateway` | Add proxy ENS observer replay harness for passive reconstructor contract | merged | PR `Project-Helianthus/helianthus-ebusgateway#375`, merge commit `97da9f9`; proxy PR `Project-Helianthus/helianthus-ebus-adapter-proxy#81` plus the final parent artifact close the replay-harness proof lane |
