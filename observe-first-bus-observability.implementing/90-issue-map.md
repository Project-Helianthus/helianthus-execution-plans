...
| `ISSUE-GW-15` | `helianthus-ebusgateway` | Proof gate and default-flip preparation | active | issue `Project-Helianthus/helianthus-ebusgateway#400`, PR `#401` merge commit `5409c216654500a7b822ab620eacf2be59ae9497`, PR `#402` (`GW-15: add P03 canary manifest and interval verifier`) merge commit `1596c9fc02a0f745996cc5c911b9b1fec2c7c22d`, PR `#403` (`GW-15: add P03 canary proof verdict gate`) merge commit `a4cb5fb82b3adea42c45912e4c8f0a2d3e2db5bb`, PR `#404` (`GW-15: add P03 proof window gate`) merge commit `977503bdab9a7bf6cb94b1b4a8243c86ed45e8b5`, PR `#406` (`gateway: canonicalize P03 proof gating and canaries`) merge commit `bf3670c362c90eb8236d2a6e3cf072a6b1c40fb5`, follow-up `#408` merge commit `f963055`, PR `#410` (`GW-15 child: add read-avoidance accounting to canonical proof artifacts`) merge commit `0a60568c1dd7eaf3745c30a5be5068bedbb22d91`, and PR `#412` (`GW-15: gate proof-window traffic minimums from transaction counters`) merge commit `21262fc885a6de8adf91b2587e27fbd4e115a6b5`; `#401`-`#404` closed the first four bounded proof-plumbing slices, `#406` canonicalized the bounded `P03` proof contract and canaries, `#408` fixed passive proof follow-up regressions, `#410` replaced placeholder read-avoidance accounting with fail-closed proof-window accounting plus current-run metrics-sequence regression rejection, and `#412` bound the proof-window traffic minimums to transaction-only completed-transaction counters and evaluated direct-apply candidate counters. The bounded canonical `P03` proof rerun now passes at `results-matrix-ha/20260315T070147Z-gw15-proof-p03-canonical-rerun/index.json`, and the passive follow-up gate passes at `results-matrix-ha/20260315T073335Z-passive-suite-followup-gate/index.json`; `ISSUE-GW-15` remains active for the remaining default-flip evidence beyond the bounded proof artifact, read-avoidance slice, and traffic/reference/promotion slices |
