...
| `ISSUE-GW-15` | `helianthus-ebusgateway` | Proof gate and default-flip preparation | active | issue `Project-Helianthus/helianthus-ebusgateway#400`, PR `#401`, merge commit `5409c216654500a7b822ab620eacf2be59ae9497`; `#401` closed the first bounded `P03` proof-plumbing slice only, so `ISSUE-GW-15` remains active for subsequent bounded proof slices |
